...
test("popover responds to hover", async () => {
	...
	//dissappearance of the popover was happening asynchronously, so it was happening after the test completed, by making the assertion asynchronous, solved the proble
